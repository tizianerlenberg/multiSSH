...
import utils.internalSshServer as internalSshServer

example_private_server_key = """
***REMOVED: example key, purged from git history***
"""[1:]
...
class SshServer():
    def __init__(self, 
                 host,
                 allowedUsers=example_allowed_users, 
        ...
        self.server = tcpServer.Server(host, serve=self.serve)
